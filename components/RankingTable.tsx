    ...
    <div className="card overflow-hidden">
      <div className="px-4 sm:px-6 py-4 border-b border-bg-border flex items-center gap-2">
        ...
        <h2 className="font-semibold">
          {preJogo ? "Palpites" : "Classificação em tempo real"}
        </h2>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted">
                    ...
                    {!preJogo && <span className="ml-2">Δ {d}</span>}
                  </div>
                </div>
                <span
                  className={cn(
                    ...
                    s.cor === "neutro" && "bg-bg-soft text-muted"
                  )}
                >
                  {s.cor === "verde" && <CheckCircle2 className="w-3.5 h-3.5" />}
                  {s.cor === "amarelo" && <CheckCircle2 className="w-3.5 h-3.5" />}
                  {s.cor === "vermelho" && <XCircle className="w-3.5 h-3.5" />}
                  {s.cor === "neutro" && <Clock className="w-3.5 h-3.5" />}
                  {s.label}
                </span>
              </motion.div>
            );
